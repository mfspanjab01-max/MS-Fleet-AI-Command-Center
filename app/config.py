...
DEFAULT_DATA_DIR = Path(os.getenv("TMPDIR", "/tmp")) / "ms-fleet-command-center" if RUNNING_ON_VERCEL else BASE_DIR / "data"
DATA_DIR = Path(os.getenv("MS_FLEET_DATA_DIR", DEFAULT_DATA_DIR))
...
DEFAULT_OLLAMA_ENABLED = "0" if RUNNING_ON_VERCEL else "1"
OLLAMA_ENABLED = os.getenv("OLLAMA_ENABLED", DEFAULT_OLLAMA_ENABLED).strip().lower() in {"1", "true", "yes", "on"}
